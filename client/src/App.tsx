...
import AdminSiteSurveys from "@/pages/admin/site-surveys";
    ...
    <SidebarProvider style={sidebarStyle}>
      <div className="flex min-h-screen w-full">
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <header className="flex items-center justify-between gap-4 p-4 border-b sticky top-0 bg-background z-[60]">
...
function AuthenticatedRoutes() {
  return (
    <Switch>
      ...
      <Route path="/admin/customer-journey">
        <ProtectedRoute allowedRoles={["admin"]}>
          <DashboardLayout>
      ...
      <Route path="/admin/customer-leads">
        <ProtectedRoute allowedRoles={["admin"]}>
          <DashboardLayout>
            <AdminCustomerLeads />
          </DashboardLayout>
      ...
      <Route path="/admin/equipment-settings">
        <ProtectedRoute allowedRoles={["admin"]}>
          <DashboardLayout>
      ...
      <Route path="/admin/vendor-payments">
        <ProtectedRoute allowedRoles={["admin"]}>
          <DashboardLayout>
            <AdminVendorPayments />
          </DashboardLayout>
      ...
      <Route path="/admin/meter-installation-reports">
        <ProtectedRoute allowedRoles={["admin"]}>
          <DashboardLayout>
      ...
      return (
        <div style={{ padding: 40, textAlign: "center", fontFamily: "system-ui" }}>
          ...
          <button
            ...
            style={{ marginTop: 16, padding: "10px 24px", background: "#f97316", color: "#fff", border: "none", borderRadius: 8, cursor: "pointer", fontSize: 16 }}
          >
            Clear Cache & Reload
          </button>
        </div>
